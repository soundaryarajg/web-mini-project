...
<div class="col-md-3 col-sm-6" style="position: absolute; left:600px;">
                        <div class="thumbnail">
                        <img src="img/custard.jpg" alt="custard">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Custard Apple</h3>
                                    ...
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        ...
                                        <?php
                                            ...
                                            if(check_if_added_to_cart(8)){
                                                ...
                                                ?>
                                                <a href="cart_add.php?id=8 && bd=1" class="btn btn-block btn-primary " name="add" value="add" class="btn btn-block btr-primary">Add to cart</a>
                                                <?php
                                            }
                                        }
                                        ?>
