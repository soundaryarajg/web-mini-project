...
<html>
    ...
    <body background="img/back.jpg">
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our Herbs and Fruits Store!</h1>
                    <p>We have the best Herbs and Fruits for you. No need to hunt around, we have all in one place.</p>
                </div>
            </div>
            <div class="container">
            <div class="row">
                                    ...
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        ...
                                        <?php
                                            ...
                                            if(check_if_added_to_cart(21)){
                                                ...
                                                ?>
                                                <a href="cart_add.php?id=21 && bd=1" class="btn btn-block btn-primary" name="add" value="add" class="btn btn-block btr-primary">Add to cart</a>
                                                <?php
                                            }
                                        }
                                        ?>
